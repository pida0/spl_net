...
LastEditTime: 2021-04-15 09:18:02
...
def train_pretext_method(gpu_id, cfg_pth):
    ...
    #======================= load data and model =======================
    trainloader, valloader, testloader = make_dataloader(cfg, [2,2,2,2])
    ...
    for epoch in range(0, cfg.TRAIN.N_EPOCH):
        ...
        for batch_idx, (imgs, labels) in enumerate(trainloader):
            ...
            loss = pst_loss + pct_loss + prt_cls_loss + prt_adv_loss*10
            ...
            if batch_idx % (print_inter) == 0:
                ...
                # iter_counter = len(trainloader) * epoch + batch_idx
